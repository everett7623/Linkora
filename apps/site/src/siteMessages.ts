...
const homeMessages = {
  en: {
    ...
    'meta.homeDescription': 'Self-hosted link management, analytics and monitoring on your Cloudflare account.',
    ...
    'home.heroLede': 'Short links, analytics, health monitoring, imports, backups and automation—deployed inside your own Cloudflare account.',
    ...
    'home.featureLede': 'Run the daily link workflow from one calm interface, while keeping D1 as your source of truth and KV as a fast redirect cache.',
    'home.featureOneTitle': 'Manage and migrate',
    'home.featureOneText': 'Create, tag, group, archive and bulk-manage links. Import Shlink, JSON or CSV safely with previews, conflict checks and migration records.',
    'home.featureTwoTitle': 'Measure what matters',
    'home.featureTwoText': 'Explore clicks, visitors, countries, devices, referers, campaigns and conversions with saved views and scheduled reports.',
    'home.featureThreeTitle': 'Monitor and recover',
    'home.featureThreeText': 'Detect broken destinations, send recovery-aware alerts, keep audit history and protect operations with backups and restore previews.',
    'home.featureFourTitle': 'Integrate on a stable API',
    'home.featureFourText': 'Build browser extensions, Shortcuts or internal tools against a versioned OpenAPI contract, scoped tokens and signed webhooks.',
    'home.productEyebrow': 'One focused workspace',
    'home.productTitle': 'Clear operations as your link library grows.',
    'home.productText': 'Simple mode keeps everyday actions close. Advanced mode reveals analytics, monitoring, automation, backups and API tools when you need them.',
    ...
    'home.architectureText': 'The redirect path stays small. Analytics and monitoring run outside the critical response, so observability cannot hold up a visitor.',
    'home.architectureNote': '<span>Principle</span> D1 is always the source of truth. KV accelerates redirects but never owns primary link state.',
    'home.deployEyebrow': 'Self-hosted on Cloudflare',
    'home.deployTitle': 'A deployment path that stays understandable.',
    'home.deployText': 'Start from Cloudflare or follow the reviewed repository workflow. Both paths keep resource ownership, secrets, dry runs and confirmation gates explicit.',
    ...
    'home.roadmapCoreText': 'Redirects, Admin, analytics, monitoring, migration, backups and OpenAPI.',
    'home.roadmapActive': 'In progress',
    'home.roadmapActiveTitle': 'Public launch foundation',
    'home.roadmapActiveText': 'Beginner deployment, project site, isolated Demo and operational hardening.',
    'home.roadmapPlanned': 'Planned',
    'home.roadmapPlannedTitle': 'Access and integrations',
    'home.roadmapPlannedText': 'Optional Cloudflare Access, async events, card views and richer link presentation.',
  ...
  'zh-CN': {
    ...
    'home.heroLede': '短链接、分析、健康监控、导入、备份与自动化，都部署在你自己的 Cloudflare 账户中。',
    ...
    'home.featureLede': '在一个克制清晰的界面中处理日常链接工作流，同时让 D1 保持为事实来源、KV 专注于加速跳转。',
    'home.featureOneTitle': '管理与迁移',
    'home.featureOneText': '创建、打标、分组、归档与批量管理链接；通过预览、冲突检查和迁移记录安全导入 Shlink、JSON 或 CSV。',
    'home.featureTwoTitle': '衡量真正重要的内容',
    'home.featureTwoText': '通过已保存视图和定时报告分析点击、访客、国家、设备、来源、活动和转化。',
    'home.featureThreeTitle': '监控与恢复',
    'home.featureThreeText': '发现失效目标、发送支持恢复的告警、保留审计历史，并用备份与恢复预览保护日常运维。',
    'home.featureFourTitle': '对接稳定 API',
    'home.featureFourText': '基于版本化 OpenAPI 契约、范围令牌和签名 Webhook 构建浏览器扩展、快捷指令或内部工具。',
    'home.productEyebrow': '一个专注的工作台',
    'home.productTitle': '链接库增长，操作依然清晰。',
    'home.productText': '简洁模式让日常动作近在手边；需要时再展开分析、监控、自动化、备份和 API 工具。',
    ...
    'home.architectureText': '跳转路径保持精简；分析和监控在关键响应之外运行，因此可观测性不会阻塞访问者。',
    'home.architectureNote': '<span>原则</span> D1 始终是事实来源。KV 负责加速跳转，不拥有主链接状态。',
    'home.deployEyebrow': '在 Cloudflare 上自托管',
    'home.deployTitle': '清晰可控的部署路径。',
    'home.deployText': '从 Cloudflare 启动，或遵循经过审查的仓库工作流。两条路径都会明确资源归属、密钥、预演和确认关卡。',
...
const deployMessages = {
  en: {
    ...
    'meta.deployDescription': 'Choose an honest Cloudflare Quick Deploy launch or a reviewed Linketry repository workflow.',
    ...
    'deploy.lede': 'Start in Cloudflare when you want a fast dashboard launch, or use the reviewed repository workflow when you need an auditable resource plan. Both paths keep your account and data in your hands.',
    'deploy.quickAction': 'Launch on Cloudflare',
    'deploy.guideAction': 'Read self-hosting guide',
    'deploy.quickLabel': 'A · Cloudflare Quick Deploy',
    'deploy.quickTitle': 'Start from the Cloudflare dashboard.',
    'deploy.quickText': "The official launcher opens Cloudflare's authenticated repository-deployment flow. It is the fastest way to begin a new installation from your own account.",
    'deploy.quickStepOne': 'Sign in to the Cloudflare account that will own the application.',
    'deploy.quickStepTwo': 'Review the repository and choose the deployment target before creating it.',
    'deploy.quickStepThree': 'Complete the required D1, KV, Pages/Admin and private Admin-token choices in the guided setup.',
    'deploy.quickActionLabel': 'Open Cloudflare deploy',
    'deploy.quickNoteTitle': 'A secure first install cannot be configuration-free.',
    'deploy.quickNote': 'A launcher cannot safely choose your account, custom hostname, D1/KV bindings, or private Admin secret. Linketry never invents those values or sends them through a public page.',
    'deploy.reviewedLabel': 'B · Reviewed repository workflow',
    'deploy.reviewedTitle': 'Provision exactly what you approve.',
    'deploy.reviewedText': "Fork the repository and use Linketry's maintained dry runs. The scripts show the D1/KV plan and require an exact confirmation phrase before any Cloudflare or GitHub write.",
    'deploy.reviewedStepOne': 'Fork Linketry into the GitHub account that will own future upgrades.',
    'deploy.reviewedStepTwo': 'Run the bootstrap and repository configuration dry runs.',
    'deploy.reviewedStepThree': 'Review the plan, confirm the exact phrase, then start the protected workflow.',
    'deploy.copyTitle': 'Guarded assistant prompt',
    'deploy.copyAction': 'Copy prompt',
    'deploy.copyStatus': 'The prompt does not ask for a token in chat, source files, logs, or command arguments.',
    ...
    'deploy.docsRecoveryText': 'Understand export, preview and restore boundaries before an upgrade.',
    'deploy.docsAction': 'Open guide',
  },
  'zh-CN': {
    'meta.deployTitle': '在 Cloudflare 上部署 Linketry',
    'meta.deployDescription': '选择透明的 Cloudflare 快速启动或经过审查的 Linketry 仓库工作流。',
    'deploy.skip': '跳至部署方案',
    'deploy.eyebrow': 'Cloudflare 部署',
    'deploy.title': '用恰当的控制力部署 Linketry。',
    'deploy.lede': '希望快速从控制台开始时选择 Cloudflare 启动；需要可审计资源计划时使用经过审查的仓库工作流。两条路径都让账户和数据保持在你手中。',
    'deploy.quickAction': '在 Cloudflare 中启动',
    'deploy.guideAction': '阅读自托管指南',
    'deploy.quickLabel': 'A · Cloudflare 快速部署',
    'deploy.quickTitle': '从 Cloudflare 控制台开始。',
    'deploy.quickText': '官方启动入口会打开 Cloudflare 已认证的仓库部署流程，这是从你自己的账户开始全新安装的最快方式。',
    'deploy.quickStepOne': '登录将拥有此应用的 Cloudflare 账户。',
    'deploy.quickStepTwo': '在创建前检查仓库并选择部署目标。',
    'deploy.quickStepThree': '在引导设置中完成必需的 D1、KV、Pages/Admin 和私有 Admin 令牌选择。',
    'deploy.quickActionLabel': '打开 Cloudflare 部署',
    'deploy.quickNoteTitle': '安全的首次安装不能没有配置。',
    'deploy.quickNote': '启动器不能替你安全选择账户、自定义主机名、D1/KV 绑定或私有 Admin 密钥。Linketry 不会虚构这些值，也不会通过公开页面传递它们。',
    'deploy.reviewedLabel': 'B · 经过审查的仓库工作流',
    'deploy.reviewedTitle': '只配置你明确批准的资源。',
    'deploy.reviewedText': 'Fork 仓库并使用 Linketry 维护的预演命令。脚本会展示 D1/KV 计划，并要求精确确认短语后才会写入 Cloudflare 或 GitHub。',
