...
- [x] Require canonical content-hashed asset paths without query or fragment identities in build and live checks.
...
- [x] Deploy v0.29.4 to production and Demo, then verify both authenticated Overview routes.
- [x] Transfer the custom-domain hashed-cache readiness false positive to the v0.29.5 follow-up task.
...
- Deployment checks remain fail-closed when Admin assets are missing, non-executable, non-hashed, or use query/fragment identities.
