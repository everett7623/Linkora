...
```json
{ "success": true, "data": { "status": "ok", "name": "Linketry", "version": "0.29.12" } }
```
...
| `LINKETRY_APPROVED_RELEASE`           | `0.29.12`            | Must match the root package version                                       |
